...
func (s *certificateService) CreateCertificate(
...
) (*models.CertificateResponse, error) {
	...
	// Tính hash cho CertHash dựa trên các trường chính của văn bằng
...
// generateCertificateHash chỉ hash các trường: họ tên, ngày sinh, mã sv, căn cước công dân, email, mã trường, mã khoa, ngành đào tạo, gpa, ngày cấp
